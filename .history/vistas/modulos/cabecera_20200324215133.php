<header class="main-header">
    ...
    <span class="logo-mini"> 
        <img src="vistas/img/plantilla/heladeria.png" class="img-responsive"
        style="padding:10px">
    </span>
    <span class="logo-lg">
        <img src="vistas/img/plantilla/logo-blanco-lineal.png" class="
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">User Admin</s pan>
                    </a>
